...
articles=bib2df("../org/cv/data/bib/articles.bib", separate_names = T) %>%
...
chapters=bib2df("../org/cv/data/bib/chapters.bib", separate_names = T) %>%
...
proceedings=bib2df("../org/cv/data/bib/proceedings.bib", separate_names = T) %>% 
