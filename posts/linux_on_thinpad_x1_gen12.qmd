...
I often use the laptop with lid closed and two external monitors attached. In that case, I don't want the authentication process to use the fingerprint reader since I can't reach it. I found a great solution [here](https://unix.stackexchange.com/a/743941/11178). Basically, open `/etc/pam.d/system-auth` and add 
